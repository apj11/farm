                            ...
                            <div class="update_blk">
                                ...
                                <div class="panel-body pt-0">
                                    <table id="datatable-resp   onsive" class="table table-striped table-bordered dt-responsive nowrap table_label_check" cellspacing="0" width="100%">
                                        ...
                                        {{--                                                                <td>{{++$key}}</td>--}}
                                        <td>{{$animalfood->food_id}}</td>
                                        <th><span class="block_element"> <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"><label for="vehicle1"> {{$animalfood->time}}</label></span>
