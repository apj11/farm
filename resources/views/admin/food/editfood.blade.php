                            ...
                            <div class="update_blk">
                                ...
                                <form action="{{route('food.update',[$food->id])}}" method="post">
                                    ...
                                    <div class="form-group flex_form">
                                        <label class="control-label">Food Name</label>
                                        <div class="col-md-10">
                                            <input type="text"  name="fname" class="form-control {{ $errors->has('fname') ? 'has-error' : '' }}"  value="{{ old('fname', isset($food) ? $food->fname : '') }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group flex_form">
                                        <label class="control-label">Food For</label>
                                    ...
                                    <div class="form-group flex_form">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="fprice" class="form-control {{ $errors->has('fprice') ? 'has-error' : '' }}"  value="{{ old('fprice', isset($food) ? $food->fprice : '') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="add_btn btn_update">
                                        <button type="submit" ><i class="fa fa-floppy-o"></i> Update Food</button>
                                    </div>
                                </form>
                            </div><!-- update_blk -->
                            <div class="row">
