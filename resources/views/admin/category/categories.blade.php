                                    ...
                                    <div class="panel-body pt-0">
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            @foreach($category as $key=>$categories )
                                                <tr id="categories{{$categories->id}}">
                                                    <td>{{++$key}}</td>
                            ...
                            <div class="col-md-5">
                                <div class="update_blk">
                                    ...
                                    <div class="form-group flex_form">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="category" class="form-control{{ $errors->has('category' ? 'has-error' :  '') }}">
                                        ...
                                        <button type="submit"  ><i class="fa fa-floppy-o"></i> Add Category</button>
{{--                                    <div class="add_btn btn_update">--}}
