                ...
                <div class="panel-body">
                    ...
                    <form action="{{route('login.store')}}" method="post" class=" " >
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" type="text" required="" placeholder="Email">
                                @if ($errors->has('email'))
                        ...
                        <div class="form-group m-t-30 m-b-0">
                            <div class="col-sm-7">
                                <a href="recoverpw.blade.php" class="text-muted"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
                            </div>
                            <div class="col-sm-5 text-right">
                                <a href="register.blade.php" class="text-muted">Create an account</a>
                            </div>
                        </div>
                    </form>
                </div>
