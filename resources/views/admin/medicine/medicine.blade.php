                                        ...
                                        <div class="update_blk">
                                            ...
                                            <div class="form-group flex_form">
                                              ...
                                              <div class="form-group flex_form">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="mprice" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="add_btn btn_update">
                                                <button type="submit" ><i class="fa fa-floppy-o"></i> Add Medicine</button>
                                            </div>
                                            </form>
                                            </div><!-- update_blk -->
                                            <div class="row">
