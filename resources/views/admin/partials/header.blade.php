<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{asset('/')}}" class="logo"><img src="{{asset('assets/images/logo_white_2.png')}}" height="28"></a>
            <a href="{{asset('/')}}" class="logo-sm"><img src="{{asset('assets/images/logo_sm.png')}}" height="36"></a>
        </div>
    </div>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>{{--<a href="javascript:void(0)"> Logout</a>--}}
                                @if(Auth::guard('admin')->check())
                                    <a href="{{route('logout')}}" class="dropdown-item"><i data-feather="log-out"></i>Logout</a>
                                @endif
                                @if(Auth::guard('web')->check())
                                    <a href="{{route('user.logout')}}" class="dropdown-item"><i data-feather="log-out"></i>Logout</a>
                                @endif
                            </li>
                        </ul>
                    </li>
