                            ...
                            <div class="update_blk">
                                ...
                                <form action="{{route('buy.update',[$buy->id])}}" method="post">
                                    ...
                                    <div class="form-group flex_form">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="buyitem" class="form-control {{ $errors->has('buyitem') ? 'has-error' : '' }}"  value="{{ old('buyitem', isset($buy) ? $buy->buyitem : '') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group flex_form">
                                        <label class="control-label">Buy From</label>
                                        <div class="col-md-10">
                                            <input type="text" name="buyfrom" class="form-control  {{ $errors->has('buyfrom') ? 'has-error' : '' }}"  value="{{ old('buyfrom', isset($buy) ? $buy->buyfrom : '') }}" required >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group flex_form">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="buyprice" class="form-control  {{ $errors->has('buyprice') ? 'has-error' : '' }}"  value="{{ old('buyprice', isset($buy) ? $buy->buyprice : '') }}" required>
                                        </div>
                                    </div>
